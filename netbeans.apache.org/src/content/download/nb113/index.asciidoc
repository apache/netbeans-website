...
A strong focus of the 11.3 release is around appearance, since the NetBeans dark look and feel support has been donated by Oracle to Apache, while FlatLaf, a completely new look and feel has been donated and integrated by Karl Tauber from FormDev Software GmbH, and enhancements for HiDPI on Windows have also been introduced.
...
- Cleaning up of many compiler warnings, for example, relating to linter warnings types of deprecation, rawtypes and unchecked.
