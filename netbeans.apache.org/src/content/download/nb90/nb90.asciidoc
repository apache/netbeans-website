...
////
Apache NetBeans 9.0 is available for download from your closest Apache mirror. For this release, only binaries are provided. Please, run the binary included in the zip files on the directory of your choice. Official installers are not provided.
...
- Windows binaries: link:https://www.apache.org/dyn/closer.cgi/incubator/netbeans/incubating-netbeans-java/incubating-9.0/incubating-netbeans-java-9.0-bin.zip[incubating-netbeans-java-9.0-bin.zip] (
...
link:https://www.youtube.com/watch?v=am-7aa2hYgc[Get Started with NetBeans from a ZIP Archive for Windows]
