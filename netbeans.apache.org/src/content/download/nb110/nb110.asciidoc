...
TIP: Since releasing 11.0, feature updates, that is, Apache NetBeans 11.1, 11.2, and 11.3 have been released. The LTS release of the Apache NetBeans 11 cycle is Apache NetBeans 11.0. The feature releases have not been tested as heavily as the LTS release and may therefore be less stable. Use 11.1, 11.2, and 11.3 to use the latest features and to provide feedback for the next LTS release, scheduled for 2020. Go here to download link:/download/nb113/nb113.html[Apache NetBeans 11.3], the latest feature update in the 11 cycle, which needs to be installed instead of 11.0, i.e., there is no automatic update between releases.
