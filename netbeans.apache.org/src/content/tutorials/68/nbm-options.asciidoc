...
NOTE: This document uses the NetBeans IDE 6.8 Release. If you are using an earlier version, see  link:67/nbm-options.html[the 6.7 version of this document].
...
image::images/nb68-options-1.png[]
...
image::images/nb68-options-2.png[]
...
image::images/nb68-options-3.png[]
