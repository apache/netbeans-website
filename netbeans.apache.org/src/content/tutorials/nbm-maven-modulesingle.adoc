...
For more details on the files that the IDE created, see  xref:../wiki/DevFaqDataObject.adoc[What is a DataObject] and the section on  xref:nbm-filetype.adoc#recognizing[Recognizing Abc Files] in the Ant-Based  xref:nbm-filetype.adoc[File Type Integration Tutorial].
