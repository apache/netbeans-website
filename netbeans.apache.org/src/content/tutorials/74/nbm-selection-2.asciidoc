...
NOTE: This document uses NetBeans Platform 7.3 and NetBeans IDE 7.3. If you are using an earlier version, see  link:72/nbm-selection-2.html[the previous version of this document].
...
For troubleshooting purposes, you are welcome to download the  link:http://web.archive.org/web/20170409072842/http://java.net/projects/nb-api-samples/show/versions/7.3/tutorials/selection-management/2-of-4/EventManager[completed tutorial source code].
