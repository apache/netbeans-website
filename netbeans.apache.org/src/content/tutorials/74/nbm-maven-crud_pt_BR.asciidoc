...
image::images/netbeans_stamp_74_73_72.png[title="O conteúdo desta página se aplica ao NetBeans IDE 6.5, 6.7, 6.8"]
...
| link:https://netbeans.apache.org/download/index.html[NetBeans IDE] |versão 6.9 (Java) 

| link:https://www.oracle.com/technetwork/java/javase/downloads/index.html[Java Developer Kit (JDK)] |Versão 6 

| link:http://maven.apache.org/[Maven] |Versão 2.0.9 ou uma mais recente 

|JavaDB ou outro servidor do banco de dados e banco de dados |  
|===
...
image::images/mavencrud-select-location.png[title="caixa de diálogo Selecionar localização do projeto mostrando o diretório do projeto"]
...
image::images/mavencrud-add-dependency1.png[title="aba Abrir projetos na caixa de diálogo Adicionar dependência"]
...
image::images/mavencrud-add-dependency-derby.png[title="Adição do JAR derbyclient na caixa de diálogo Adicionar dependência"]
...
image::images/mavencrud-new-window-customer.png[title="página Configuração básica do assistente Nova janela"]
...
image::images/mavencrud-myeditor-window.png[title=" Componente de janela na visualização Desenho"]
...
image::images/mavencrud-new-action.png[title="Registro GUI no assistente Nova ação"]
...
image::images/abc16.png[title="Ícone do modelo 16 x 16"] )
