...
| link:https://netbeans.apache.org/download/index.html[NetBeans IDE] |version 7.2 or 7.3 

| link:https://www.oracle.com/technetwork/java/javase/downloads/index.html[Java Developer Kit (JDK)] |version 7 or above 

| link:http://repo1.maven.org/maven2/net/java/dev/rome/rome/1.0.0[Rss and atOM utilitiEs] 

| link:http://repo1.maven.org/maven2/net/java/dev/rome/rome-fetcher/1.0.0[Rome Fetcher] 
