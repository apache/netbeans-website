...
NOTE:  This document uses NetBeans IDE 7.2 or above and NetBeans Platform 7.2 or above. If you are using an earlier version, see  link:71/nbm-filetype.html[the previous version of this document].
...
image::images/new-filetype-1.png[]
...
image::images/new-filetype-2.png[]
...
image::images/new-filetype-3.png[]
...
image::images/new-filetype-4.png[]
