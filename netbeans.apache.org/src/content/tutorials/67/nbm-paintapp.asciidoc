...
That's it! Your first complete application built on top of the NetBeans Platform is finished. Next stop:  link:https://netbeans.apache.org/tutorials/nbm-feedreader.html[NetBeans Platform Feed Reader Tutorial]. 
