...
You will be shown how to change the explorer view from BeanTreeView to TreeTableView, MenuView, ListView, and all the other views supported by the  link:https://bits.netbeans.org/dev/javadoc/org-openide-explorer/overview-summary.html[Explorer and Property Sheet API].
...
* NetBeans IDE 5.0 or 5.5 Beta 2 ( link:https://netbeans.apache.org/download/index.html[download])
