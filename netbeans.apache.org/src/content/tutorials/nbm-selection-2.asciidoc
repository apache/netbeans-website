...
image::images/nbm-selection2/explorer1.png[]
...
image::images/nbm-selection2/result1.png[]
...
image::images/nbm-selection2/result2.png[]
...
image::images/nbm-selection2/result6.png[]

* *MenuView* - a `JButton` that pops up a menu of a Node and its children

image::images/nbm-selection2/result7.png[]
...
image::images/nbm-selection2/multiselect1.png[]
