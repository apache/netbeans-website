...
image::images/maven-command-platform-default-1.png[title="Screenshot of default application"]
...
image::images/maven-command-platform-default-2.png[title="Screenshot of default application"]
