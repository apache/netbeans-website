...
Using the instructions in this subsection, you can create a richly structured and deeply nested project hierarchy, because each subproject can provide its own subprojects, too. For further information on this topic, see  xref:../blogs/geertjan/org_netbeans_spi_project_subprojectprovider.adoc[this blog entry],  xref:../blogs/geertjan/org_netbeans_spi_project_subprojectprovider1.adoc[this blog entry], and  xref:../blogs/geertjan/org_netbeans_spi_project_subprojectprovider2.adoc[this blog entry].
