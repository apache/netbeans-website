...
* *AbcDataObject.java.* Wraps a  ``FileObject`` . DataObjects are produced by DataLoaders. For more information, see  xref:../wiki/DevFaqDataObject.adoc[What is a DataObject?].
