...
image::images/netbeans-stamp8-9.png[title="Content on this page applies to NetBeans IDE 6.5, 6.7, 6.8"]
...
* In the  ``EditorTopComponent``  constructor, add a call to fire a method (which will be defined in the next step) whenever a change is detected:
