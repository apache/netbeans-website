...
The NetBeans Platform tutorials assume that you are familiar with some of the basic terms that relate to NetBeans module development. The terms are few and not very difficult. Once you have grasped the concepts below, you should consider reading  xref:../wiki/NbmIdioms.adoc[Introduction to the NetBeans Idioms and Infrastructure].
