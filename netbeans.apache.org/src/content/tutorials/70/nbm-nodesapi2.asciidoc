...
NOTE:  This document uses the NetBeans IDE 7.0 Release or above. If you are using an earlier version, see  link:691/nbm-nodesapi2.html[the previous version of this document].
...
new AbstractNode(Children.create(new MyChildren(), true), Lookups.singleton(key));
----
