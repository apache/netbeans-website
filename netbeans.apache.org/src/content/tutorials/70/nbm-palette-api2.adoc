...
NOTE: This document applies to NetBeans IDE 6.7 and above. If you are using an earlier version, see  link:68/nbm-palette-api2.html[the earlier version of this document].
