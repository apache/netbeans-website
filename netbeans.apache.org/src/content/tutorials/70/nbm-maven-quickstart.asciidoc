...
image::images/maven-newproject.png[title="Screenshot of New Project wizard"]
...
image::images/maven-wizard-project-location.png[title="Screenshot of New Project wizard"]
...
image::images/maven-projects-libraries.png[title="Screenshot of Add Dependency dialog"]
...
image::images/maven-final-app.png[title="Screenshot of final NetBeans Platform application"]
