...
image::images/quickstart_platform_new-project-1.png[width=450]
...
image::images/quickstart_platform_new-project-2.png[width=450]
...
image::images/quickstart_platform_new-module-2.png[width=450]
...
image::images/quickstart_platform_new-module-3.png[width=450]
...
image::images/quickstart_platform_new-window-2.png[width=450]
...
image::images/quickstart_platform_new-window-3.png[width=450]
...
image::images/quickstart_platform_new-window-4.png[width=450]
...
image::images/quickstart_platform_new-window-6.png[width=450]
...
image::images/quickstart_platform_new-window-7.png[width=450]
...
image::images/quickstart_platform_new-app-2.png[width=450]


[start=2]
1. Enter a text in lowercase in the text area, and click "Filter!".

image::images/quickstart_platform_new-app-3.png[width=450]

You should see that the text is now shown in uppercase:

image::images/quickstart_platform_new-app-4.png[width=450]
...
image::images/quickstart_platform_new-api-2.png[width=450]

Click btn:[Next]. Set the Code Name Base to be `org.word.editor.api`, as shown below:


image::images/quickstart_platform_new-api-3.png[width=450]
...
image::images/quickstart_platform_new-api-9.png[width=450]
...
image::images/quickstart_platform_new-impl-2.png[width=450]

Click btn:[Next]. Set the Code Name Base to `org.word.editor.uppercase`, as shown below:

image::images/quickstart_platform_new-impl-3.png[width=450]
...
image::images/quickstart_platform_new-impl-6.png[width=450]

Click btn:[OK].

A confirmation dialog will appear:

image::images/quickstart_platform_new-impl-7.png[width=450]
...
image::images/quickstart_platform_new-impl-10.png[width=450]
...
image::images/quickstart_platform_new-impl-12.png[width=450]
...
image::images/quickstart_platform_new-history-1.png[width=450]
...
image::images/quickstart_platform_new-history-2.png[width=450]
...
image::images/quickstart_platform_new-history-3.png[width=450]
...
image::images/quickstart_platform_new-result-1.png[width=450]
