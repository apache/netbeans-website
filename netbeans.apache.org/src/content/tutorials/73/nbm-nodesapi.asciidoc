...
NOTE: This document uses NetBeans Platform 7.1 and NetBeans IDE 7.1. If you are using an earlier version, see  link:70/nbm-nodesapi.html[the previous version of this document].
