...
During the next five years Oracle has also been supporting the NetBeans Project with some server infraestructure (and a great team!). This has been of course of great help, and has allowed us to move forward. We want to thank Oracle for all this help.
