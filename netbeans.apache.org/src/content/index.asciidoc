...
Apache NetBeans can be link:http://localhost:8080/download/nb100/nb100.html[installed] on all operating systems that support Java, i.e, Windows, Linux, Mac OSX and BSD. Write Once, Run Anywhere, applies to NetBeans too.
