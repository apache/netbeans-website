...
Some other module entirely actually registers an implementation of this interface in the xref:DevFaqLookupDefault.adoc[default Lookup].  link:http://bits.netbeans.org/dev/javadoc/org-openide-awt/org/openide/awt/StatusDisplayer.html[StatusDisplayer] is a good example of this pattern.
