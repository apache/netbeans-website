...
based projects in NetBeans IDE. To quote the link:http://maven.apache.org/[Maven project site], "Maven is a software project management and comprehension tool.
...
article, please visit the link:http://maven.apache.org/[project site] and read
the link:http://maven.apache.org/articles.html[available books and articles] on
the subject.
...
NOTE: Please refer to Apache Maven link:http://maven.apache.org/pom.html[POM
...
For more details, see the link:http://maven.apache.org/settings.html[Settings
Reference] page
...
link:http://repo1.maven.org/maven2[central repository]. Among other things it
...
link:http://maven.apache.org/guides/introduction/introduction-to-dependency-mechanism.html[dependency mechanism].
...
link:http://maven.apache.org/scm/scms-overview.html[Maven SCM] on the
...
link:../kb/docs/java/maven-dependencies-screencast.html[Working with Maven
...
* link:../kb/docs/java/maven-hib-java-se.html[Creating a Maven Swing Application Using Hibernate]
* link:../kb/docs/javaee/maven-entapp.html[Creating an Enterprise Application Using Maven]
* link:http://nbstaging.czech/kb/docs/javaee/maven-osgi-declarativeservices.html[OSGi Declarative Services Using Maven]
* link:../tutorials/nbm-maven-quickstart.html[NetBeans Platform Quick Start Using Maven]
* link:../tutorials/nbm-maven-modulesingle.html[Creating a NetBeans Module Using Maven]
* link:../tutorials/nbm-maven-modulesuite.html[Working with NetBeans Module Suites]
* link:../tutorials/nbm-maven-crud.html[Creating NetBeans Platform CRUD Application Using Maven]
* link:../kb/docs/java/maven-dependencies-screencast.html[Video of Working with Maven Dependencies]
