...
Use the link:http://bits.netbeans.org/dev/javadoc/org-netbeans-modules-options-api/overview-summary.html[Options Dialog and SPI] as explained in the link:https://netbeans.apache.org/tutorials/nbm-options.html[NetBeans Options Window Module Tutorial].
