...
. Follow the coding conventions of the file. Your code should match that style and not stand out. For new files, please follow the link:codeconventions.html[code conventions for the NetBeans code base].
