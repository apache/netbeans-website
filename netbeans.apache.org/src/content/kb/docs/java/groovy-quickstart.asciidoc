...
WARNING: JIRA link:https://issues.apache.org/jira/browse/NETBEANS-1996[] has to be solved for the Java editor to recognize the Groovy reference and for code completion shown above to work.
