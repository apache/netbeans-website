...
1. Between the braces, type `psvm` and press the Tab key. You should now see `public static void main` statement. 

2. Within the `public static void main` statement, type `sout` and press the Tab key. You should now see a 'System.out.println' statement.
