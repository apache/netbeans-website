...
*  link:http://bits.netbeans.org/dev/javadoc/[NetBeans API Javadoc] ( xref:../../../download/index.adoc[download javadoc.zip for offline viewing])
...
*  link:../../../tutorials/nbm-ant.adoc[Ant]
*  link:../../../tutorials/nbm-maven-commandline.adoc[Maven]
