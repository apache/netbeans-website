...
* https://netbeans.apache.org/wiki/DevFaqIndex.asciidoc[+DevFaq wiki+], by the community
...
* link:https://www.oracle.com/technical-resources/articles/javase/extensible.html[+Creating Extensible Applications With the Java Platform+]
...
* link:http://blogs.oracle.com/geertjan[+Geertjan Wielenga+], link:http://blogs.kiyut.com/tonny/[+Tonny Kohar+].
