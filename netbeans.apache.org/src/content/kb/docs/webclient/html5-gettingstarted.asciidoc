...
* <<installchrome,Using the IDE with the Chrome Browser>>
* <<installchrome1,Installing the Extension from the Chrome Web Store>>
* <<installchrome2,Offline Installation of the Extension>>
* <<webkit,Using the Embedded WebKit Browser>>
* <<createproject,Creating a NetBeans HTML5 Project>>
* <<usingbower,Installing and Using Bower>>
* <<editingpage,Editing the HTML File>>
* <<saving,Saving the Project as a Site Template>>
* <<summary,Summary>>
* <<seealso,See Also>>
