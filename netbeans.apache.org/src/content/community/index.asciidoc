...
The Apache NetBeans Community uses the link:mailing-lists.html[mailing lists] as the primary source of communication. See how to stay informed and in touch with other NetBeans users and developers.
