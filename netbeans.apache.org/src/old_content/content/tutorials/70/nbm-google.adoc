...
image::images/google_70_action-wiz-1.png[] Click Next.
...
image::images/google_70_action-wiz-2.png[] Click Next.
...
image::images/google_70_action-wiz-3.png[] 
...
image::images/google_70_google-result-2.png[]
...
image::images/google_70_google-panel-1.png[]
...
image::images/google_70_google-panel-2.png[]
...
image::images/google_70_google-panel-4.png[] Click OK. The IDE creates the following import statements for  ``GooglePanel.java`` :
...
image::images/google_70_create-nbm.png[] 
