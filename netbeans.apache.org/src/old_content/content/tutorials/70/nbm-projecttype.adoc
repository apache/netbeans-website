...
image::images/projecttypes_70pics_sample-2.png[]
...
[start=2]
1. Run the module that you created in this tutorial. A new instance of your NetBeans IDE starts up. Now your new project type is installed in NetBeans IDE. Open the sample projects you created in the previous step.
...
image::images/projecttypes_70pics_nb-sample-proj2.png[]

Once you have completed the wizard, use it again to register your second sample project:


image::images/projecttypes_70pics_nb-sample-proj3.png[]
...
image::images/projecttypes_70pics_nb-sample-proj4.png[]
