...
NOTE: This document uses NetBeans Platform 7.1 and NetBeans IDE 7.1. If you are using an earlier version, see  link:../70/nbm-porting-basic.html[the previous version of this document].
...
image::images/porting_70_ag0.png[]
...
image::images/porting_70_ag1.png[]
...
image::images/porting_70_ag2.png[]
...
image::images/porting_70_agp0.png[]
...
image::images/porting_70_agp01.png[]
...
image::images/porting_70_agp02.png[]
...
image::images/porting_70_agp03.png[]
...
image::images/porting_70_agp04.png[]
...
image::images/porting_70_agp2.png[]
...
image::images/porting_70_agp4.png[]
...
image::images/porting_70_agport0.png[]
...
image::images/porting_70_agport0a.png[]
...
image::images/porting_70_agport0b.png[]
...
image::images/porting_70_agport0c.png[]
...
[start=1]
1. Right-click the `com.toy.anagrams.core` package in the Projects window and then choose New > Other. Under Categories, select Module Development. Under File Types, select Window. Click Next.


[start=2]
1. Choose the position where you would like the window to appear. For purposes of this tutorial choose "editor", which will place the Anagram Game in the main part of the application. Also check the first checkbox, to specify that the window should open automatically when the application starts up. Click Next.
...
image::images/porting_70_agport6.png[]
...
image::images/porting_70_agport8.png[]
...
image::images/porting_70_agport8a.png[]
...
image::images/porting_70_agport9.png[]
...
image::images/porting_70_agport10.png[]
...
image::images/porting_70_ageditorcookie3.png[]
...
image::images/porting_70_ageditorcookie4.png[]
