...
<li><a href="#_how_do_i_make_a_link_to_an_external_web_page_open_in_the_ides_external_web_browser">How do I make a link to an external web page open in the IDE&#8217;s external web browser?</a></li>
...
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">public class MyBeautifulDialogPanel {
...
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">public Help Ctx getHelp() {
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">&lt;mapID target="UniqueHelpId" url="PathFromMapFileToHelpFileInHelpSet"/&gt;</code></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">-J-Dorg.netbeans.modules.javahelp.level=100</code></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;map version="2.0"&gt;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">new HelpCtx("myPluginAboutMapID").display();</code></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;a href="nbdocs://org.netbeans.modules.db/org/netbeans/modules/db/docs/connectdb.html"&gt;Connecting
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;?xml version='1.0' encoding='ISO-8859-1'  ?&gt;
&lt;!DOCTYPE toc PUBLIC "-//Sun Microsystems Inc.//DTD JavaHelp TOC Version 2.0//EN"
         "<a href="http://java.sun.com/products/javahelp/toc_2_0.dtd">http://java.sun.com/products/javahelp/toc_2_0.dtd</a>"&gt;
&lt;toc version="2.0"&gt;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;indexitem text="databases" &gt;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;tocitem text="My Cool Plug-in" &gt;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;h6&gt;standard project&lt;/h6&gt;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;object classid="java:com.sun.java.help.impl.JHSecondaryViewer"&gt;
...
<div class="sect1">
<h2 id="_how_do_i_make_a_link_to_an_external_web_page_open_in_the_ides_external_web_browser">How do I make a link to an external web page open in the IDE&#8217;s external web browser?</h2>
<div class="sectionbody">
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;object classid="java:org.netbeans.modules.javahelp.BrowserDisplayer"&gt;
    &lt;!-- Enter the URL below --&gt;
    &lt;param name="content" value="<a href="http://www.netbeans.org/kb/41/freeform-config.html">http://www.netbeans.org/kb/41/freeform-config.html</a>"&gt;
    &lt;!-- Enter the display text below. The &lt;html&gt; and &lt;u&gt; make the text look like a link. --&gt;
    &lt;param name="text" value="&lt;html&gt;&lt;u&gt;<a href="http://www.netbeans.org/kb/41/freeform-config.html">http://www.netbeans.org/kb/41/freeform-config.html</a>&lt;/u&gt;&lt;/html&gt;"&gt;
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">&lt;link rel="StyleSheet"
