...
<ul class="sectlevel2">
<li><a href="#__code_jmap_code_and_built_in_dumpers_in_jdk"><code>jmap</code> and built-in dumpers in JDK</a></li>
...
<div class="sect2">
<h3 id="__code_jmap_code_and_built_in_dumpers_in_jdk"><code>jmap</code> and built-in dumpers in JDK</h3>
<div class="sect3">
