...
<div class="sect2">
<h3 id="_how_do_i_set_the_version_number">How do I set the version number?</h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="_how_do_i_set_the_version_number_automatically_in_maven_based_applications">How do I set the version number automatically in maven-based applications?</h3>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqVersionNumber.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
