...
<div id="toctitle"></div>
<ul class="sectlevel1">
<li><a href="#_how_to_use_the_diff_view_in_my_own_applicationplugin">How to use the diff view in my own application/plugin</a>
<ul class="sectlevel2">
<li><a href="#_show_non_editable_diff_for_files">Show non-editable diff for files</a></li>
<li><a href="#_show_editable_diff_for_nodes_with_fileobject_in_nodes_lookup">Show editable diff for nodes with FileObject in node&#8217;s lookup</a></li>
...
<div class="sect1">
<h2 id="_how_to_use_the_diff_view_in_my_own_applicationplugin">How to use the diff view in my own application/plugin</h2>
<div class="sectionbody">
<div class="sect2">
<h3 id="_show_non_editable_diff_for_files">Show non-editable diff for files</h3>
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">@ActionID(category = "Tools", id = "org.my.diff.DiffViewerAction")
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">        String contentType = fo.getMIMEType();
...
<div class="sect2">
<h3 id="_show_editable_diff_for_nodes_with_fileobject_in_nodes_lookup">Show editable diff for nodes with FileObject in node&#8217;s lookup</h3>
<div class="ulist">
<ul>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">package de.markiewb.netbeans.sample.editablediff;
