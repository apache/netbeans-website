...
<div class="sect2">
<h3 id="_override_the_code_beforelookup_lookup_template_template_code_method">Override the <code>beforeLookup(Lookup.Template&lt;?&gt; template)</code> method</h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="_use_code_instancecontent_convertor_code_to_create_a_placeholder_object">Use <code>InstanceContent.Convertor</code> to create a placeholder object</h3>
<div class="paragraph">
