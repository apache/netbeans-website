...
<div id="toctitle"></div>
<ul class="sectlevel1">
<li><a href="#_how_can_i_create_a_fileobject_in_memory">How can I create a FileObject in memory?</a></li>
...
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    FileSystem fs = FileUtil.createMemoryFileSystem();
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqFileObjectInMemory.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
