...
<li><a href="#_what_about_processes_using_the_system_outsystem_err">What about processes using the System.out/System.err?</a></li>
...
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">private class ProcessLaunch implements Callable&lt;Process&gt; {
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">ExecutionDescriptor descriptor = new ExecutionDescriptor().controllable(true).frontWindow(true).
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">ExecutionService exeService = ExecutionService.newService(
...
<div class="sect1">
<h2 id="_what_about_processes_using_the_system_outsystem_err">What about processes using the System.out/System.err?</h2>
<div class="sectionbody">
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">private void redirectSystemStreams() {
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">IOProvider.getDefault().getIO(name, false).getOut().println(mess);</code></pre>
</div>
</div>
<div class="paragraph">
