...
<div id="toctitle"></div>
<ul class="sectlevel2">
<li><a href="#_how_can_i_be_notified_when_a_file_is_opened">How can I be notified when a file is opened?</a></li>
<li><a href="#_apache_migration_information">Apache Migration Information</a></li>
</ul>
</div>
<div class="sect2">
<h3 id="_how_can_i_be_notified_when_a_file_is_opened">How can I be notified when a file is opened?</h3>
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code class="language-java" data-lang="java">import java.beans.PropertyChangeEvent;
...
<div class="paragraph">
<p>This page was exported from <a href="http://wiki.netbeans.org/DevFaqListenForOpenEvents">http://wiki.netbeans.org/DevFaqListenForOpenEvents</a> ,
that was last modified by NetBeans user Markiewb
on 2013-02-03T16:11:47Z.</p>
</div>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqListenForOpenEvents.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
