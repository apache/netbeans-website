...
<div class="sect1">
<h2 id="_how_can_i_be_notified_when_a_file_is_opened">How can I be notified when a file is opened?</h2>
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqListenForOpenEvents.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
