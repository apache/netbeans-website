...
<div id="toctitle"></div>
<ul class="sectlevel2">
<li><a href="#_i_got_a_code_classnotfoundexception_code_or_code_noclassdeffounderror_code_how_can_i_fix_it">I got a <code>ClassNotFoundException</code> or <code>NoClassDefFoundError</code>. How can I fix it?</a></li>
<li><a href="#_apache_migration_information">Apache Migration Information</a></li>
</ul>
</div>
<div class="sect2">
<h3 id="_i_got_a_code_classnotfoundexception_code_or_code_noclassdeffounderror_code_how_can_i_fix_it">I got a <code>ClassNotFoundException</code> or <code>NoClassDefFoundError</code>. How can I fix it?</h3>
<div class="paragraph">
...
<div class="content">
<pre class="prettyprint highlight"><code class="language-java" data-lang="java">verify-class-linkage: Warning: a.SomeImplementation cannot access b.publicapi.SomeInterface</code></pre>
</div>
</div>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqTroubleshootClassNotFound.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
