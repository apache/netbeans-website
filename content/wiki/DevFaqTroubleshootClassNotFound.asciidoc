...
<div class="sect1">
<h2 id="_i_got_a_code_classnotfoundexception_code_or_code_noclassdeffounderror_code_how_can_i_fix_it">I got a <code>ClassNotFoundException</code> or <code>NoClassDefFoundError</code>. How can I fix it?</h2>
