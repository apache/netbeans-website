...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">long t0 = System.nanoTime();
try {
  ... measured code
} finally {
...
<div class="sect2">
<h3 id="_how_to_measure_performanceresponsiveness">How to measure performance/responsiveness?</h3>
<div class="paragraph">
