...
<div class="sect2">
<h3 id="_i_need_to_write_some_code_that_tracks_the_global_selection_what_should_i_do">I need to write some code that tracks the global selection. What should I do?</h3>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqTrackGlobalSelection.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in github.</a></li>
    </ul>
</section>
