...
<strong>Note:</strong> The above will work with any distribution method (i.e. zip, installer, etc&#8230;&#8203;)
&lt;/ol&gt;</p>
</div>
</div>
</div>
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqJavaStartParms.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
