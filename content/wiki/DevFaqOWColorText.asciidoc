...
<head>
    ...
    <meta name="description" content="Apache NetBeans wiki DevFaqOWColorText">
    <meta name="author" content="Apache NetBeans">
    <meta name="keywords" content="Apache NetBeans wiki DevFaqOWColorText">
...
<div id="toctitle"></div>
<ul class="sectlevel1">
<li><a href="#_how_to_use_color_text_in_output_window">How to use color text in Output Window</a>
<ul class="sectlevel2">
...
<div class="sect1">
<h2 id="_how_to_use_color_text_in_output_window">How to use color text in Output Window</h2>
<div class="sectionbody">
<div class="paragraph">
<p>You can use IO extension classes like <code>IOColorPrint</code>, <code>IOColorLines</code>. Default colors can be changed via <code>IOColors</code>.</p>
</div>
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code class="language-java" data-lang="java">InputOutput io = IOProvider.getDefault().getIO("test", true);
...
<div class="paragraph">
<p>See <a href="http://plugins.netbeans.org/plugin/39695/?show=true">here</a> for a plugin that has a convenient class that takes care of the dirty work and even handles <code>OutputListeners</code>.</p>
</div>
<div class="paragraph">
<p>&lt;hr/&gt;
Applies to: NetBeans 6.7 or later, (IOColorPrint 6.8 or later).</p>
</div>
<div class="sect2">
...
<div class="paragraph">
<p>This page was exported from <a href="http://wiki.netbeans.org/DevFaqOWColorText">http://wiki.netbeans.org/DevFaqOWColorText</a> ,
that was last modified by NetBeans user Jhavlin
on 2011-12-12T13:36:25Z.</p>
</div>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqOWColorText.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in github.</a></li>
    </ul>
</section>
