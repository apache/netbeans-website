...
<div id="toctitle"></div>
<ul class="sectlevel1">
<li><a href="#_after_adding_my_class_to_lookup_i_get_a_classnotfoundexception_when_trying_to_look_it_up_why">After adding my class to Lookup I get a "ClassNotFoundException" when trying to look it up, why?</a>
<ul class="sectlevel2">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqLookupPackageNamingAndLookup.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in github.</a></li>
    </ul>
</section>
