...
<div id="toctitle"></div>
<ul class="sectlevel2">
<li><a href="#_can_i_bind_one_key_to_more_than_one_action">Can I bind one key to more than one action?</a></li>
<li><a href="#_apache_migration_information">Apache Migration Information</a></li>
</ul>
</div>
<div class="sect2">
<h3 id="_can_i_bind_one_key_to_more_than_one_action">Can I bind one key to more than one action?</h3>
<div class="paragraph">
...
<div class="sect3">
<h4 id="_what_about_binding_a_key_differently_in_different_windows">What about binding a key differently in different windows?</h4>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqRebindingKeys.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in github.</a></li>
    </ul>
</section>
