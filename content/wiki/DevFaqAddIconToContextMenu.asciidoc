...
<head>
    ...
    <meta name="description" content="Apache NetBeans wiki DevFaqAddIconToContextMenu">
    <meta name="author" content="Apache NetBeans">
    <meta name="keywords" content="Apache NetBeans wiki DevFaqAddIconToContextMenu">
...
<div id="toctitle"></div>
<ul class="sectlevel2">
<li><a href="#_how_do_i_add_an_icon_to_the_context_menu">How do i add an icon to the context menu?</a></li>
<li><a href="#_apache_migration_information">Apache Migration Information</a></li>
</ul>
</div>
<div class="sect2">
<h3 id="_how_do_i_add_an_icon_to_the_context_menu">How do i add an icon to the context menu?</h3>
...
<ul>
<li>
<p>let your action implement Presenter.Popup and return a JMenuItem instance for the current action (see [1], [2])</p>
</li>
<li>
<p>set the icon via putValue(javax.swing.Action.SMALL_ICON, &#8230;&#8203;)</p>
</li>
<li>
<p>set the icon via putValue("iconBase", &#8230;&#8203;) to make it work properly in the toolbar. Otherwise you will get a fixed size icon.</p>
</li>
<li>
<p>By using setEnabled, it makes sure every listener will be notified (JButton, JMenuItem&#8230;&#8203;). Moreover it is safer to call it on the EDT since it is not sure which thread triggered the event in the first place.</p>
</li>
</ul>
</div>
...
<div class="paragraph">
<p>This page was exported from <a href="http://wiki.netbeans.org/DevFaqAddIconToContextMenu">http://wiki.netbeans.org/DevFaqAddIconToContextMenu</a> ,
that was last modified by NetBeans user Jmborer
on 2013-10-17T13:27:02Z.</p>
</div>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqAddIconToContextMenu.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
