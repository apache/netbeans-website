...
<div id="toctitle"></div>
<ul class="sectlevel1">
<li><a href="#_how_do_i_create_my_own_tab_in_the_output_window_and_write_to_it">How do I create my own tab in the output window and write to it?</a></li>
...
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">InputOutput io = IOProvider.getDefault().getIO ("Hello", true);
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqOutputWindow.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
