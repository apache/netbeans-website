...
<head>
    ...
    <title>DevFaqActionAddAnyFolder</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Apache NetBeans wiki DevFaqActionAddAnyFolder">
    <meta name="author" content="Apache NetBeans">
    <meta name="keywords" content="Apache NetBeans wiki DevFaqActionAddAnyFolder">
...
<div id="toctitle"></div>
<ul class="sectlevel2">
<li><a href="#_how_can_i_add_actions_to_all_folder_nodes">How can I add actions to all folder nodes?</a></li>
<li><a href="#_apache_migration_information">Apache Migration Information</a></li>
</ul>
</div>
<div class="sect2">
<h3 id="_how_can_i_add_actions_to_all_folder_nodes">How can I add actions to all folder nodes?</h3>
<div class="paragraph">
<p>Register to <strong>Loaders/folder/any/Actions</strong></p>
</div>
<div class="paragraph">
<p>Example:</p>
</div>
...
<div class="paragraph">
<p>This page was exported from <a href="http://wiki.netbeans.org/DevFaqActionAddAnyFolder">http://wiki.netbeans.org/DevFaqActionAddAnyFolder</a> ,
that was last modified by NetBeans user Markiewb
on 2013-07-07T19:41:45Z.</p>
</div>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqActionAddAnyFolder.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in github.</a></li>
    </ul>
</section>
