...
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">Node[] arr = TopComponent.getRegistry().getCurrentNodes();
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">Set&lt;TopComponent&gt; comps = TopComponent.getRegistry().getOpened();
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    private Collection&lt;TopComponent&gt; getCurrentOpenedEditors() {
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    private TopComponent getCurrentEditor() {
