...
<div class="sect1">
<h2 id="_i_have_a_folder_full_of_instance_files_how_do_i_get_any_all_of_the_object_instances">I have a folder full of .instance files. How do I get any/all of the object instances?</h2>
