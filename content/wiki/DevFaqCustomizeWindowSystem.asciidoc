...
<div class="sect1">
<h2 id="_turn_some_features_on_off_on_topcomponent_level">Turn some features on/off on TopComponent level</h2>
<div class="sectionbody">
<div class="paragraph">
...
<div class="sect1">
<h2 id="_turn_some_features_on_off_on_window_system_level">Turn some features on/off on window system level</h2>
<div class="sectionbody">
<div class="paragraph">
