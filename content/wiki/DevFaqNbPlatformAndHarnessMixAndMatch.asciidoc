...
<div class="sect1">
<h2 id="_i_want_to_use_one_version_of_the_platform_with_another_version_of_the_build_harness_can_i">I want to use one version of the Platform with another version of the build harness. Can I?</h2>
