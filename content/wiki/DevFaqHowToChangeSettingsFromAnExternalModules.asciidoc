...
<div class="sect2">
<h3 id="_how_do_you_change_the_configuration_of_other_modules">How do you change the configuration of other modules?</h3>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqHowToChangeSettingsFromAnExternalModules.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
