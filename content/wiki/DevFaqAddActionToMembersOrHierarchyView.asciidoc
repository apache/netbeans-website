...
<div id="toctitle"></div>
<ul class="sectlevel2">
<li><a href="#_how_do_i_add_an_action_to_the_context_menu_of_the_members_or_hierarchy_view">How do I add an action to the context menu of the members or hierarchy view?</a></li>
<li><a href="#_apache_migration_information">Apache Migration Information</a></li>
</ul>
</div>
<div class="sect2">
<h3 id="_how_do_i_add_an_action_to_the_context_menu_of_the_members_or_hierarchy_view">How do I add an action to the context menu of the members or hierarchy view?</h3>
<div class="paragraph">
...
<div class="content">
<pre class="prettyprint highlight"><code class="language-java" data-lang="java">Navigator/Actions/Members/text/x-java
...
<div class="sect3">
<h4 id="_a_more_or_less_complete_example">A more or less complete example:</h4>
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code class="language-java" data-lang="java">package de.markiewb.netbeans.sample.extendMembersAndHierarchyView;
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqAddActionToMembersOrHierarchyView.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
