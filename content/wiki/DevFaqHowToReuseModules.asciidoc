...
<li><a href="#_how_to_make_global_updates_and_updates_into_a_custom_target_clusterfolder_work_in_a_netbeans_platform_application">How to make global updates and updates into a custom target cluster/folder work in a NetBeans Platform application</a></li>
</ul>
</li>
...
<div class="content">
<pre class="prettyprint highlight"><code data-lang="xml">&lt;target name="create-update-center" depends="harness.taskdefs, nbm"&gt;
...
<div class="sect2">
<h3 id="_how_to_make_global_updates_and_updates_into_a_custom_target_clusterfolder_work_in_a_netbeans_platform_application">How to make global updates and updates into a custom target cluster/folder work in a NetBeans Platform application</h3>
<div class="olist arabic">
<ol class="arabic">
<li>
