...
<div class="sect2">
<h3 id="_how_can_code_in_one_module_be_notified_when_other_modules_are_loaded_or_unloaded">How can code in one module be notified when other modules are loaded or unloaded?</h3>
<div class="paragraph">
...
<section class='tools'>
    ...
    <ul class="menu align-center">
        ...
        <li><a href="https://github.com/apache/incubator-netbeans-website/blob/master/netbeans.apache.org/src/content/wiki/DevFaqModuleLoadUnloadNotification.asciidoc" title="See this page in github"><i class="fa fa-md fa-edit"></i> See this page in GitHub.</a></li>
    </ul>
</section>
