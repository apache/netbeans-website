...
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    File tutorialFile = getFile(getSourceDir(), "/org/netbeans/test/codegen/Tutorial1.java");
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    Task task = new Task&lt;WorkingCopy&gt;() {
        ...
    }</code></pre>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    ModificationResult result = tutorialSource.runModificationTask(task);
