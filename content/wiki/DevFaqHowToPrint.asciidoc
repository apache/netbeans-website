...
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    public class MyComponent extends javax.swing.JComponent {
      public MyComponent() {
        ...
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    putClientProperty("print.name", &lt;name&gt;); // NOI18N</code></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    putClientProperty("print.size", new Dimension(printWidth, printHeight)); // NOI18N</code></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="prettyprint highlight"><code data-lang="java">    putClientProperty("print.order", &lt;order&gt;); // NOI18N</code></pre>
</div>
</div>
<div class="paragraph">
